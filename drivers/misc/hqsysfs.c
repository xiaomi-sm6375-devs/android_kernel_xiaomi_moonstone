...
static ssize_t pcba_config_show(struct device *dev,
...
static DEVICE_ATTR(pcba_config, 0444, pcba_config_show, NULL);

static struct attribute *huaqin_attrs[] = { &dev_attr_pcba_config.attr, NULL };
